...
predicates
  ...
  %pada predikat factorial ini memiliki 2 argumen dengan tipe data yang beda, yang pertama tipe dataya unsigned dan yg kedua real
  factorial(unsigned,real,unsigned,real) - procedure (i,o,i,i) 
  %predikat factorial ini dideklarasikan lagi tapi disini ada 4 argumen beda dengan yang pertama yang hanya 2 argumen
...
clauses
  factorial(N,FactN):- %Pada klausa ini adalah klausa pertama yang dicocokan dengan goal. Ada 2 argumen yang terdapat di klausa yaitu N dan FactN.%
	...
	factorial(N,FactN,1,1.0). %Klausa ini adalah sub dari klausa pertama yang berarti jika, pada factorial ini memiliki 4 argumen antara lain (N,FactN,1,1.0). Sebelumya kan sudah diketahui nilai N yaitu 3 maka hasil factorial ini adalah (3,FactN,1,1.0)%
  ...
  factorial(N,FactN,I,P):- %Pada klausa ini factorial punya 4 argumen antara lain (N,FactN,I,P) nilai masing masing dari ini adaklah N=3,I=1 dan P=1.0. Tapi nilai FactN belum diketahui
	...
	%Dan factorial ini punya 4 argumen yang nilainya hasil dari penghitungan diatas.
goal
  factorial(3,X).
